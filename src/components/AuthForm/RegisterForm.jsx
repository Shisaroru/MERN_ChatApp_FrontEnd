    ...
    return (
        <form action="#" method='POST' onSubmit={submitHandler} className={styles.form_container}>
            ...
            <div className={styles.input_container}>
                ...
                <input type="text" name="name" className={styles.input_field} id="name" value={payloads.name} required
            ...
            <div className={styles.input_container}>
                <label htmlFor="phoneNumber" className={styles.input_label}>Phone number</label>
                <input type="tel" name="phoneNumber" className={styles.input_field} id="phoneNumber" value={payloads.phoneNumber} required
                    onChange={e => setPayloads({...payloads, phoneNumber: e.target.value})}
                />
            </div>
            <div className={styles.input_container}>
            ...
            <div>
                ...
                <Link to="/" id={styles.navigate}>Login</Link>
            </div>
        </form>
    )
}
